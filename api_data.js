define({ "api": [
  ...
  },
  {
    ...
    "description": "<p><a href=\"https://developer.github.com/v3/git/refs/#create-a-reference\">REST API doc</a></p>",
    "group": "Gitdata",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "title": "get",
    "name": "get",
    "description": "<p>Each time the pull request receives new commits, GitHub creates a merge commit to <em>test</em> whether the pull request can be automatically merged into the base branch. (This <em>test</em> commit is not added to the base branch or the head branch.)</p> <p>The value of the <code>merge_commit_sha</code> attribute changes depending on the state of the pull request. Before a pull request is merged, the <code>merge_commit_sha</code> attribute holds the SHA of the <em>test</em> merge commit. After a pull request is merged, the attribute changes depending on how the pull request was merged: If the pull request was merged as a merge commit, the attribute represents the SHA of the merge commit. If the pull request was merged via a squash, the attribute represents the SHA of the squashed commit on the base branch. If the pull request was rebased, the attribute represents the commit that the base branch was updated to.</p> <p>The value of the <code>mergeable</code> attribute can be <code>true</code>, <code>false</code>, or <code>null</code>. If the value is <code>null</code>, this means that the mergeability hasn't been computed yet, and a background job was started to compute it. Give the job a few moments to complete, and then submit the request again. When the job is complete, the response will include a non-<code>null</code> value for the <code>mergeable</code> attribute.</p> <p>Pass the appropriate <a href=\"https://developer.github.com/v3/media/#commits-commit-comparison-and-pull-requests\">media type</a> to fetch diff and patch formats. <a href=\"https://developer.github.com/v3/pulls/#get-a-single-pull-request\">REST API doc</a></p>",
    "group": "PullRequests",
    "parameter": {
      "fields": {
        "Parameter": [
