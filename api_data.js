define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await octokit.gists.edit({gist_id, description, files, files.content, files.filename})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "octokit.gists.edit({gist_id, description, files, files.content, files.filename}).then(result => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await octokit.gitdata.getReferences({owner, repo, namespace, per_page, page})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "octokit.gitdata.getReferences({owner, repo, namespace, per_page, page}).then(result => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await octokit.projects.getProjectCards({column_id, archived_state, per_page, page})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "octokit.projects.getProjectCards({column_id, archived_state, per_page, page}).then(result => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await octokit.projects.updateProjectCard({card_id, note, archived})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "octokit.projects.updateProjectCard({card_id, note, archived}).then(result => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "title": "createFile",
    "name": "createFile",
    "description": "<p>This method creates a new file in a repository <a href=\"https://developer.github.com/v3/repos/contents/#create-a-file\">REST API doc</a></p>",
    "group": "Repos",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await octokit.repos.getDeploymentStatuses({owner, repo, deployment_id, per_page, page})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "octokit.repos.getDeploymentStatuses({owner, repo, deployment_id, per_page, page}).then(result => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "async/await",
        "content": "const result = await octokit.repos.getProtectedBranchTeamRestrictions({owner, repo, branch, per_page, page})",
        "type": "js"
      },
      {
        "title": "Promise",
        "content": "octokit.repos.getProtectedBranchTeamRestrictions({owner, repo, branch, per_page, page}).then(result => {})",
        "type": "js"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "title": "updateFile",
    "name": "updateFile",
    "description": "<p>This method updates a file in a repository <a href=\"https://developer.github.com/v3/repos/contents/#update-a-file\">REST API doc</a></p>",
    "group": "Repos",
    "parameter": {
      "fields": {
        "Parameter": [
