const routes = require('../plugins/rest-api-endpoints/routes')
...
require('fs').writeFileSync(require('path').join(__dirname, '..', 'plugins', 'rest-api-endpoints', 'routes.json'), JSON.stringify(routes, null, 2) + '\n')
