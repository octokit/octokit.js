...
var Client = module.exports = function (config) {
  ...
  if (config.followRedirects) {
    console.log('DEPRECATED: followRedirects option is no longer supported. All redirects are followed correctly')
  }

  if (config.Promise) {
    console.log('DEPRECATED: Promise option is no longer supported. The native Promise API is used')
  }
